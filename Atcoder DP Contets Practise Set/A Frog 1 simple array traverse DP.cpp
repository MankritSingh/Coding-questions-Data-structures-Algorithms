...
Analysis:We should try to see the independent problems that exist in the whole problem.For eg here we think that the cost to arrive
at the final rock must be what?
we know that we can only arrive at final rock i from the rock i-1 and rock i-2.
Therefore this tells us one important thing that if we know the min cost to arrive at the rock i-1 and i-2 then its simple to 
know the min cost to arrive at rock i. Extending this logic we can say that min cost to reach rock i-1 is easliy calculated by
knowing the cost of rock i-2 and rock-3.
