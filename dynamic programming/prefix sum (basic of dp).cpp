/* Question:we are given an array and we need to find the sum of the given ranges,for eg sum[0,6],sum[1,6]  etc.
   ...
   Prefix sum approach:We will find the prefix sum of the given array.First we make an array of the sam size,then we find the consective sums as we go on.
